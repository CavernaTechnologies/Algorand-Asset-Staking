    ...
    public class AlcheFactory
    {
        ...
        public AlcheFactory(IIndexerUtils indexerUtils, IAlgodUtils algodUtils)
        {
            ...
            sets = new AlcheSet[]
            {
                ...
                // Set 7
                new AlcheSet(50_000, new ulong[]{976607072},  new ulong[]{976606055, 976603928}, new ulong[]{976602491, 976598073, 976593947, 976588947}, new ulong[]{976587029, 976591691, 976596812, 976601214}, new ulong[]{976584825, 976591691, 976595331, 976599867}),
            };
        }
