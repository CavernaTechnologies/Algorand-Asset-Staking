...
namespace Airdrop.AirdropFactories.Holdings
{
    public class BlopHoldingsFactory : HoldingsAirdropFactory
    {
        public BlopHoldingsFactory(IIndexerUtils indexerUtils, IAlgodUtils algodUtils) : base(indexerUtils, algodUtils)
        {
            ...
            this.RevokedAddresses = new string[] { "U4WMQCXM7655FIJS6AYBKC6A3R74X2XZ3T4SPJV52BQVJ5WF7HTYKGQQ74", "HMKN4BCGCDUFWIPOIKDBUTC6RXFKOKOB6TWO25ETRHTKJFTJZPD6Y3BOLQ", "TXS3EHXOP2FJWVZXI3FM2N34HTM5TPL77VFDIU4WI22IVOUDNIQCEPYMDY" };
        ...
        public override async Task<IDictionary<ulong, ulong>> FetchAssetValues()
        {
            ...
            assetValues[1017527898] = 20000;
            assetValues[1022013377] = 20000;
            assetValues[1022361083] = 20000;
            assetValues[1077952679] = 20000;

            assetValues[827254442] = 30000;
            assetValues[908977667] = 30000;
            assetValues[1010200962] = 30000;
            assetValues[1124377754] = 30000;
