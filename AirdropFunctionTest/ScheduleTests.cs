...
namespace FunctionTest
{
    public class ScheduleTests
    {
        ...
        [Fact]
        public void FrogHoldingsAirdropScheduleTest()
        {
            Assert.Equal("0 0 23 * * Fri", Function.FrogHoldingsAirdropSchedule);
        }

        [Fact]
        public void BeaverHoldingsAirdropScheduleTest()
        {
        ...
        [Fact]
        public void AlgaeHoldingsAirdropScheduleTest()
        {
            Assert.Equal("0 0 16 * * Mon", Function.AlgaeHoldingsAirdropSchedule);
        }
    }
}
